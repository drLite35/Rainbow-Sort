...
(function() {
  var UPDATE_INTERVAL, bogoSort, bsort, canvas, colours, context, defer, height, hsort, initColours, isort, qsort, rectHeight, rectWidth, reset, sort, sort_context, ssort, swapRects, timeouts, toHslString, width;
